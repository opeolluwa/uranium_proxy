...
//     fn default() -> Self {
//         match Self {
//             AppError::BadCredentialsError { message } => AppError::BadCredentialsError { message },
//             AppError::ServerError { message } => AppError::ServerError { message },
//             AppError::BadCredentialsError { message } => AppError::BadCredentialsError { message },
//             AppError::WrongCredentialsError { message } => {
//                 AppError::WrongCredentialsError { message }
//             }
//             AppError::DatabaseError { message } => AppError::DatabaseError { message },
//             AppError::NotFoundError { message } => AppError::NotFoundError { message },
//             AppError::ConflictError { message } => AppError::ConflictError { message },
//         }
//     }
// }
